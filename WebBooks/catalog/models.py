...
class Book(models.Model):
    title = models.CharField(max_length=200, help_text='Введите название', verbose_name='Название книги')
    ...
    author = models.ManyToManyField('Autor', help_text='Выберите автора книги', verbose_name='Автор книги')
